---
layout: post
title: Flo Tools 2026.8.2
permalink: /Flo-Tools-2026.8.2/
---
...
The following commands stopped working over time because Avid has renamed various menus or buttons. Naturally, these commands in Flo Tools 2026.8 will not work as expected with earlier versions of Pro Tools where the buttons and menus reflect the older names.
...
A new addition to Flo Tools 2026.8 is the ability to speak and choose presets in the Audio Suite window. The keyboard shortcut is Option+Command+P which is the same as the shortcut in the Plugin window. Also, as in the Plugin window, Left bracket and Right Bracket selects the previous and next presets if available for the chosen plugin.
...
* Fixed the bug where Check for New Update notifies for an update even though you have the latest version installed.
* Fixed the bug where the auto updater crashes when it cannot send a speech announcement.
